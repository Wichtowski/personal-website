      ...
      {articles.map((article) => (
        <motion.div key={article.slug} variants={itemVariants}>
          <Link
            ...
            className="group p-6 rounded-2xl border border-border/30 bg-muted/5 hover:bg-muted/10 hover:border-primary/25 transition-all duration-300 relative focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 flex flex-col md:flex-row md:items-center justify-between gap-6"
          ...
          >
            <article className="contents">
              ...
              <div
                className="self-end md:self-auto flex items-center justify-center p-3 rounded-full border border-border/50 bg-background text-muted-foreground group-hover:border-primary group-hover:text-primary transition-all duration-300 transform group-hover:translate-x-1 shrink-0"
                aria-hidden="true"
              >
                <ArrowRight size={18} />
              </div>
